    ...
    <div className="min-h-screen bg-gray-50 pb-16">
      <header className="bg-white shadow-sm border-b">
        <div className="flex items-center justify-between p-4">
          <div className="text-lg font-bold text-gray-800">Shibaura Fes</div>
  ...
  return (
    <div className="p-4 space-y-6">
      <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg p-6 text-white">
        <h1 className="text-2xl font-bold mb-2">芝浦フェス 2024</h1>
        <p className="text-blue-100">昼休みステージイベント開催中！</p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-white rounded-lg p-4 shadow-sm border">
          ...
          <p className="text-sm text-gray-600">レジャーシートの予約状況を確認</p>
        </div>
        ...
        <div className="bg-white rounded-lg p-4 shadow-sm border">
          ...
          <p className="text-sm text-gray-600">パフォーマンスにリアルタイムで反応</p>
        </div>
      ...
      <div className="bg-white rounded-lg p-4 shadow-sm border">
        ...
        <div className="bg-red-50 rounded-lg p-3">
          ...
          <p className="text-sm text-gray-600 mt-2">軽音楽部による弾き語りライブ</p>
        </div>
      </div>
    </div>
  )
